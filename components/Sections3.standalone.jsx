    ...
    <div className={`splash ${phase}`}>
      ...
      <div className="splash-content">
        ...
        <div className="splash-logo-wrap">
          <img src={window.__resources.logo} alt="HertzGo" className="splash-logo"/>
        </div>
...
const FixedLogo = () => {
  return (
    <a href="#top" className="fixed-logo" aria-label="Voltar ao topo">
      ...
      <img src={window.__resources.logo} alt="HertzGo"/>
    </a>
  );
};
...
const Loyalty = () => {
  ...
  return (
    <section className="float-section loyalty-float" id="fidelidade">
      <div className="float-bg" style={{backgroundImage:`url(${window.__resources.p05})`}}></div>
