...
const Stats = () => (
  <section className="float-section stats-float" id="numeros">
    <div className="float-bg" style={{backgroundImage:`url(${window.__resources.p01})`}}></div>
...
const Tech = () => {
  ...
  return (
    <section className="float-section tech-float" id="tecnologia">
      <div className="float-bg" style={{backgroundImage:`url(${window.__resources.p04})`}}></div>
...
const Diffs = () => {
  ...
  return (
    <section className="float-section diffs-float" id="diferenciais">
      <div className="float-bg" style={{backgroundImage:`url(${window.__resources.p08})`}}></div>
      <div className="float-scrim"></div>
      <div className="wrap">
        <div className="float-head reveal">
