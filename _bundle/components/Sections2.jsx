...
const Gallery = () => {
  ...
  const photos = [
    window.__resources.p01,
    window.__resources.p08,
    window.__resources.pRender,
    window.__resources.p04,
    window.__resources.p07,
    window.__resources.p05,
    window.__resources.p06,
  ];
  const handleErr = (e) => {
...
const HertzGoApp = () => {
  ...
  return (
    <section className="float-section app-float" id="app">
      <div className="float-bg" style={{backgroundImage:`url(${window.__resources.pRender})`}}></div>
...
const Vision = () => {
  ...
  const screens = [
    { src: window.__resources.vd01, title: "Status da Rede", desc: "Faturamento, energia, sessões e disponibilidade em tempo real — Move + Spott unificados." },
    { src: window.__resources.vd03, title: "Histórico Anual", desc: "Faturamento mensal por estação, crescimento total, disponibilidade média anual." },
    { src: window.__resources.vd02, title: "IA & Horário de Pico", desc: "Heatmap de pico, insights automáticos por IA e detecção de oportunidades." },
  ];
